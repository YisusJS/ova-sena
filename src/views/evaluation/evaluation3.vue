...
export default {
  ...
  setup() {
    ...
    const answersA = ref([
      ...
      {text: 'Gimnasia de trampolín, gimnasia estática, gimnasia rítmica',value: false},
      {text: 'Velocidad de piernas, parada de manos con impulso, fuerza de brazo',value: false},
    ...
    const answersB = ref([
      ...
      {text: 'Gimnasia artística, gimnasia rítmica, deportiva, acrobática',value: true},
      {text: 'Rollo adelante, contracción muscular, fuerza de brazo',value: true},
