  ...
  <main class="container-setSports">
    <section class="module">
      <div class="module__title-container" id="6.1">
        <h2 class="module__title">Futuro contenido 1</h2>
      </div>
    ...
    <section class="module">
      <div class="module__title-container" id="6.2">
        <h2 class="module__title">Futuro contenido 2</h2>
      </div>
      <div class="module__content">
        <p>
          El término Motricidad surge del estudio desde el punto de vista
    ...
    <section class="module">
      <div class="module__title-container" id="6.3">
        <h2 class="module__title">Futuro contenido 3</h2>
      </div>
      <div class="module__content">
        <p>
          El término Motricidad surge del estudio desde el punto de vista
