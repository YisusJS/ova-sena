  ...
  <main class="container-motorSkills">
    ...
    <section class="module">
      <div class="module__title-container" id="1.3">
        <h2 class="module__title">Desarrollo OMP 2-3 años</h2>
      </div>
      <div class="module__content">
        <p>
          ...
          detectar en análisis de sangre de un adulto, por lo cual es
          fundamental el estudio endocrino en los niños con el fin de detectar
          su nivel de desarrollo según la edad. El desarrollo del sistema
          muscular es estrechamente asociado al del sistema esquelético ya que
          va ligado al aumento de la estatura. El desarrollo de capacidades
          físicas como la fuerza y la alimentación balanceada según los
          requerimientos nutricionales de acuerdo con la edad serán
