    ...
    <section class="module">
      ...
      <div class="module__content">
        <p>
          ...
          crecimiento de la masa muscular. En la niñez los niveles hormonales
          son inferiores en comparación a las concentraciones que se pueden
          detectar en análisis de sangre de un adulto, el control periódico de
          las hormonas generadas por las glándulas endocrinas del niño ayuda a
          detectar el nivel de desarrollo según la edad. El desarrollo del
          sistema muscular es estrechamente asociado al del sistema esquelético
          ya que va ligado al aumento de la estatura. El desarrollo de
          capacidades físicas como la fuerza y la alimentación balanceada según
          los requerimientos nutricionales de acuerdo con la edad serán
          fundamentales para un sano desarrollo óseo y muscular. El desarrollo
          óseo y muscular va acompañado del psicológico, en la primera infancia
          el niño se caracteriza por ser un pequeño explorador, por algunas
          diferencias sexuales anatómicas, las relaciones afectivas, la
          creatividad, el egocentrismo, la socialización y control de las
          ...
          pequeños realizados por las manos, los dedos, como vestirse, pasar las
          páginas de un libro, armar torres, enroscar y desenroscar entre otros.
    ...
    <section class="module">
      ...
      <div class="module__content">
        <p>
          ...
          del programa Técnico en Ejecución de Programas Deportivos. El
          entrenamiento de la fuerza en la etapa infantil debe ser equilibrado
          de tal forma que pueda contribuir con un desarrollo armónico de todos
          los segmentos musculares, haciendo énfasis en las posturas lo cual
          deberá incidir en el crecimiento adecuado del sistema óseo. En cuanto
          al desarrollo óseo hay variaciones definidas según el sexo. La
          maduración ósea en las niñas es más rápida que en los niños durante la
          primera década de vida. El perímetro cefálico solo aumenta de 2 a 3
          cm., en la totalidad de la fase. La estatura entre los siete (7) y los
          doce (12) se incrementa de 5 a 8 cm., y casi duplican su peso. Aparece
          el primer y segundo molar, se presenta incremento de la motricidad
          fina facilitando a los niños escribir y dibujar con mayor precisión.
          ...
          deberes. Los infantes en edades escolares cada vez son más fuertes,
          rápidos y coordinados disponiendo de un cuerpo apto para el
          aprendizaje de habilidades (Hofferth y Sandberg, 1998). Se presentan
          diferencias en las condiciones motrices entre los niños y las niñas
          las cuales evidencian superioridad en la motricidad fina mientras que
          los niños mejoran la motricidad gruesa la cual incide en el desarrollo
          de la fuerza. También se incrementa el ritmo y lateralidad.
        </p>
      </div>
    </section>
    <section class="module">
